...
BINARIES="tests/simple/subl.o tests/simple/addl_imm_reg.o tests/simple/movl_imm.o tests/simple/movl_reg_reg.o tests/simple/addl_reg_reg.o tests/simple/imull.o tests/simple/simple_return.o tests/simple/jmp.o tests/simple/shrl.o tests/moderate/movl_deref.o tests/moderate/movl_deref2.o tests/moderate/pushpop.o tests/moderate/callret.o tests/moderate/stack_multibyte.o tests/moderate/cmpl.o tests/moderate/je.o tests/moderate/jl.o tests/moderate/jle.o tests/moderate/jge.o tests/moderate/jbe.o tests/complex/factorial.o tests/complex/log2.o tests/complex/sort.o"
